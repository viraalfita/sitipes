...
<div class="card mt-5 bg-dark shadow-sm">
    ...
    <div class="my-3 p-3 bg-dark">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="tahun" id="tahun" value="{{Session::get('tahun')}}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="nominal" class="col-sm-2 col-form-label text-light">Nominal</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="nominal" id="nominal" value="{{Session::get('nominal')}}">
            </div>
        </div>
