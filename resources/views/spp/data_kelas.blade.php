...
<div class="container">
    ...
    <div class="card rounded shadow-sm bg-gray">
        <div class="card-header">
            <h1 class="text-gray">Data Kelas</h1>
        </div>
        <div class="card-body">
            <div class="my-2 p-3 bg-dark rounded">
                {{-- Pencarian --}}
                <div class="pb-3">
                    <form action="{{url('kelas')}}" class="d-flex" method="get">
                ...
                {{-- Tambah Data --}}
                <div class="pb-3">
                    <a href="{{url('kelas/create')}}" class="btn btn-transparent border-secondary text-gray">+ Tambah Data</a>
                </div>
                ...
                <table class="table table-dark table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2 text-center">Nama Kelas</th>
                            <th class="col-md-4 text-center">Kompetensi Keahlian</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$dat->kompetensi_keahlian}}</td>
                            <td class="text-center">
                                <a href='{{url('kelas/'.$dat->id.'/edit')}}' class="btn btn-transparent btn-sm">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="{{url('kelas/'.$dat->id)}}" method="POST">
            @csrf
            @method('DELETE')
